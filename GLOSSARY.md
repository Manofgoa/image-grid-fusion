...
| Effect (*effet*) | A transformation of a cell + image pair, toggled from the effects toolbar: Zoom, Rotate, Flip, Frames, Black & white, Blur |
| Effects toolbar | The always-visible row below the top bar: the "Effects" label, the effect toggles, the Reset button |

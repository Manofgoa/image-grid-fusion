...
| Effect (*effet*) | A transformation of a cell + image pair, turned on or off from the effects toolbar: Zoom, Rotate, Flip, Frames, Black & white, Blur. Turned off, it keeps its settings |
